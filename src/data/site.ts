...
export const profile = {
  ...
  title: 'Systems and Embedded Engineer',
  location: 'Santa Cruz, CA',
  description:
    'Bay Area systems and embedded software engineer building C++ concurrency libraries, FreeRTOS telemetry prototypes, application security tools, and AI evaluations.',
  summary:
...
export const projects: Project[] = [
  {
    index: '01',
    name: 'EmbNode',
    tagline: 'C++17 FreeRTOS telemetry prototype',
    ...
    facts: [
      'Sampler, aggregator, and communications task scaffolding',
      'DMA and hardware transport integration remain platform work',
      'Host tests cover CRC, malformed frames, power accounting, and OTA failures',
      'Power calculations are modeled, not physical current measurements',
    ],
    focus: {
      problem: 'Intermittent networks and low-power constraints make telemetry delivery unreliable.',
      systemDesign: 'FreeRTOS task scaffolding separates simulated sampling, aggregation, and transport hooks.',
      evidence: 'Host contract tests exercise packet validation, power accounting, and OTA backend failures.',
      outcome: 'A testable telemetry foundation; hardware DMA, network delivery, and field reliability still need validation.',
    },
    metrics: [
      { value: 'CRC16', label: 'Packet validation' },
      { value: 'Host', label: 'Contract tests' },
      { value: 'C++17', label: 'Telemetry prototype' },
    ],
    stack: [
      'C++17',
      'FreeRTOS',
    ...
    links: [
      { label: 'View EmbNode source', href: 'https://github.com/nmapaye/embnode' },
      { label: 'Read the telemetry design', href: '/writing/embnode-telemetry-design/' },
    ],
  },
  {
    index: '02',
    name: 'SysLib',
    tagline: 'C++20 systems and concurrency library',
    description:
      'A header-only systems library with a lock-free SPSC ring, a blocking MPMC queue, and RAII resource wrappers.',
    facts: [
      'SPSC ownership and acquire/release publication',
      'MPMC mutex, condition-variable waits, and immediate value destruction',
    ],
    focus: {
      problem: 'Concurrent data-structure experiments need a small surface that makes correctness work explicit.',
      systemDesign: 'Header-only C++20 SPSC atomics and a mutex-based MPMC queue keep ownership explicit.',
      evidence: 'Tests cover wraparound, move-only values, wakeups, value lifetime, and concurrent delivery.',
      outcome: 'A focused library for examining queue behavior, with sanitizer build options and explicit limitations.',
    },
    stack: [
      'C++20',
      'Atomics',
    ...
    links: [
      { label: 'View SysLib source', href: 'https://github.com/nmapaye/syslib' },
      { label: 'Read the concurrency design', href: '/writing/syslib-concurrency-design/' },
    ],
  },
  {
    index: '03',
